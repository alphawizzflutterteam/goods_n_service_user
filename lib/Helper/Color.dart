...
extension colors on ColorScheme {
  ...
  static const Color primary = Color(0xff9a37e2);
  static const Color secondary = Color(0xfffcc53c);
  ...
  static const Color grad1Color = Color(0xfffcc53c);
  static const Color grad2Color = Color(0xff4609cc);
  static const Color lightWhite2 = Color(0xffEEF2F3);

  static const Color yellow = Color(0xfffcc53c);

  static const Color red = Color(0xff9a37e2);
